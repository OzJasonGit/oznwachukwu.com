            ...
            <section class="center-holder">
                ...
                <div class="grid-0">
                    ...
                    <div id="GRID-1">
                        ...
                        <div class="title-holder-desktop">
                            <div class="three-holder">
                                ...
                                <div id="HOME-TEXT" class="container">
                                    <span id="BLOG-TITLE" class="h1-title-text">oznwachukwu.com</span>
                                    <span id="BLOG-DESCRIPTION" class="h2-hero-text">SOFTWARE ENGINEER | ARB RIBA ARCHITECT |
                                        DESIGNER | BIM ENGINEER</span>
                                    <span id="AUTHOR" class="p-body-text">My work navigates the spaces between
                                        design, technology
                                        and engineering.
                        ...
                        <div id="TEXT-1" class="container">
                            <span id="DESCRIPTION-TEXT" class="p-body-text">
